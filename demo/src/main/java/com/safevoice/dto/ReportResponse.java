...
public class ReportResponse {
    ...
    public ReportResponse(Long id, String token, String title, String category, String severity,
                         String description, String status, String adminResponse,
                         String assignedDepartment, LocalDateTime createdAt) {
        this.id = id;
        this.token = token;
        this.title = title;
